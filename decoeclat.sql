...
CREATE TABLE carrito (
  carrito_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
ALTER TABLE "carrito" ADD FOREIGN KEY ("cliente_id") REFERENCES "clientes" ("cliente_id");

ALTER TABLE "carrito_items" ADD FOREIGN KEY ("carrito_id") REFERENCES "carrito" ("carrito_id");

ALTER TABLE "carrito_items" ADD FOREIGN KEY ("variante_id") REFERENCES "variantes_producto" ("variante_id");
